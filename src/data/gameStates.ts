...
export const gamesStates: IGameState[] = [
  {
    ...
    Довкола вас повна тиша, і ви не пам'ятаєте, як сюди потрапили. 
  ...
  },
  {
    ...
    text: `Ви обираєте стежку, що спускається до річки. Прогресуючи вниз, ви чуєте шум води, який стає все гучнішим по мірі наближення до річки.
           Приходячи до берега, ви бачите, як річка повільно пливе своїм широким руслом. Ви помічаєте невеликий човен, що стоїть біля берега.`,
    options: [
  ...
  {
    id: 5,
    text: `Крокуючи вздовж хребта помічаємо вказівник`,
    options: [
  ...
  {
    id: 9,
    text: `Ви вирішили не випробувати долю і повернутися назад.
    Крокуючи подалі від густого лісу ви помічаєте печеру з  таємничим блиском`,
    options: [
  ...
  {
    id: 12,
    text: `Ви занурюєтеся у потік і піднімаєте розколотий камінь. Діставши його з води, ви помічаєте, що всередині маленький кришталевий кулон з чарівним візерунком на ньому.
  ...
  },
  {
    ...
    Але, ось незворотний момент: ви розумієте, що маючи мотузку, якою можна б було зафіксуватися, можна врятуватися і подолати скелю.
     Ваші руки спливають від поту, і ви відчуваєте, як втрачаєте стійкість. Серце б'ється швидше, а паніка поступово охоплює вас.`,
    options: [
      {
  ...
  },
  {
    ...
    text: `Ви вирішили дослідити руїни. Підходите до старовинної споруди з захопленням.
           ...
           Увійшовши в середину, ви помічаєте ознаки колишнього життя. 
...
`,
  ...
  },
  {
    ...
    text: `Ви з панікою біжите з печери, відчуваючи ведмедя, який наближається до вас. 
        Ви намагаєтеся рухатися швидко і непомітно, уникати гілок і кущів, щоб не привертати увагу. 
  ...
  {
    id: 39,
    text: `Ви намагаєтеся проплисти через густий ліс, оминаючи водоворотів, місця скупчення крокодилів, та небезпечних місць. Але втрачаєте пильність і підводний камінь різко зупиняє
    човен скидаючи вас у річку, ручку з крокодилами! 
         `,
...
Лісовий пропонує вам безпечне пристанище в своїй оселі, де ви можете відпочити,
